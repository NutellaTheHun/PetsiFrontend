...
import { type GenericTableColumn } from "../generics/table/GenericTable";
import { MantineTableWithSelection } from "../uiComponents/Table/MantineTableWithSelection";
...
export function NewEntityTableFactory<
    T extends { id: number },
    TEditContext extends BaseEditContext,
    TCreateContext extends BaseCreateContext,
    TSortKey extends string
>(
    ...
    return (
        <MantineTableWithSelection<T, TSortKey, TEditContext, TCreateContext>
            data={statefulData}
            columns={columns}
