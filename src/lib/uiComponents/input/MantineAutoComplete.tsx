...
import type { StringKeys } from "./MantineMultiSelectCheckbox";
...
interface MantineAutoCompleteProps<T> {
    totalOptions: T[];
...
export function MantineAutoComplete<T>({
    totalOptions,
    selectedOption,
    onOptionChange,
    searchProperty,
}: MantineAutoCompleteProps<T>) {
