...
import { PetsiLogo } from "../PetsiLogo";
import { LogoutButton } from "./LogoutButton";
import classes from "./Navbar.module.css";
import { NavbarItem, type NavbarItemProps } from "./NavbarItem";

// Admin Panel
export const adminPanelItem: NavbarItemProps = {
    label: "Admin",
    icon: IconFocusAuto,
...
// Order Management
export const orderManagementItem: NavbarItemProps = {
...
export const inventoryManagementItem: NavbarItemProps = {
...
// Recipe Costing
export const recipeCostingItem: NavbarItemProps = {
    label: "Recipe Costing",
    icon: IconChefHat,
    initiallyOpened: false,
};

export function getAuthorizedUserFeatureLinksGroupProps(): NavbarItemProps[] {
    return getAuthorizedUserFeatures()
        .map((feature) => FeatureNavbarItemMap[feature])
        .filter((item): item is NavbarItemProps => !!item);
}
