        ...
        <Routes>
          ...
          >
            <Route element={<OrderManagementPage />}>
              <Route index element={<OrderDashboardWindow />} />
              <Route path={ROUTE.ORDER.ORDERS} element={<OrdersWindow />}>
                <Route path={ROUTE.ORDER.ORDER} element={<OrderWindow />} />
              </Route>
              <Route path={ROUTE.ORDER.ITEMS} element={<ItemsWindow />}>
                <Route path={ROUTE.ORDER.ITEM} element={<ItemWindow />} />
              </Route>
              <Route path={ROUTE.ORDER.LABELS} element={<LabelsWindow />}>
                <Route path={ROUTE.ORDER.LABEL} element={<LabelWindow />} />
              </Route>
              <Route path={ROUTE.ORDER.TEMPLATES} element={<TemplatesWindow />}>
                <Route
                  path={ROUTE.ORDER.TEMPLATE}
                  element={<TemplateWindow />}
                />
              </Route>
              <Route path={ROUTE.ORDER.REPORTS} element={<ReportsWindow />} />
              <Route
          ...
          >
            <Route element={<InventoryManagementPage />}>
              <Route index element={<InventoryDashboardWindow />} />
              <Route
          ...
          >
            <Route path={ROUTE.RECIPE.ROOT} element={<RecipeCostingView />}>
              <Route index element={<RecipeDashboardWindow />} />
              <Route path={ROUTE.RECIPE.RECIPES} element={<RecipesWindow />}>
                <Route path={ROUTE.RECIPE.RECIPE} element={<RecipeWindow />} />
              </Route>
            </Route>
          </Route>
